...
Try {
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		Show-InstallationWelcome -CloseApps 'outlook,word,excel,powerpoint,lync' -CheckDiskSpace -PersistPrompt
		...
		Execute-Process -Path "$dirFiles\S4B.exe" -Parameters '/configure S4B.xml' -WindowStyle 'Hidden'
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'outlook,word,excel,powerpoint,lync'

		## Show Progress Message (with the default message)
		Show-InstallationProgress

		## <Perform Pre-Uninstallation tasks here>
		Execute-Process -Path "$dirFiles\S4B.exe" -Parameters '/download S4BRemove.xml' -WindowStyle 'Hidden'
		Execute-Process -Path "$dirFiles\S4B.exe" -Parameters '/configure S4BRemove.xml' -WindowStyle 'Hidden'
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDCmJBbju3Hh1yG
# ROyzxFlgh4kUOvNftkbC9wFvKIb526CCEdcwggVvMIIEV6ADAgECAhBI/JO0YFWU
...
# BgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCDXs9BshNK1VQI7TpGEMVD34XKz
# W0hE1o7T69uYshr4dzANBgkqhkiG9w0BAQEFAASCAYBlSKu1XrRmsn9hJSS4aL9E
# dkiRifriwU10x+1XDDcEbX0lBl3Y+s9lcaUWSjggtHlqdshnBorAmVHHTlzlf/2U
# hsXE1WLT0JHOPGHHxEa+PSRF649oRIX51lBFP7QHY4z9ha4h5ZSeg+rjHttsSgf6
# GK8C9xGJfqOIzagp5wQm6M/oIjjCDu8R06MCii1RtVWTarKQ8AjEfojMQqfaH0gK
# b0rbBVzAA4miMOlusrcpjoNjmG5wvXNmTizrbx6d6vX+f4WCFl1Bk5Aay4KHYVAp
# tZPLqYvTKJz9igzWpzB60XIDAN7qZPSCdMBod7/AG42SRifgudBCbEkRM4yMpPlO
# fBIOqX/40MNbzzmin9GvUWUdQlXtfSu9mF4WP1ma3QZol7xWBVfZO1OG3hG0lx4J
# lcILPx9vTk4jQ8I5Msh8Of6EU2J8MRKsepmdOioiJLusBXhR6gAhNrziEpJMaNAr
# 90C6w8da8p0vUcmEt2Rz+IglaKPNazIk+ibcOWS247g=
